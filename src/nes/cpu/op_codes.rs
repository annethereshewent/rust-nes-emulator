...
lazy_static! {
  pub static ref INSTRUCTIONS: Vec<Instruction> = vec![
    ...
    Instruction::new(0xE0, AddressingMode::Immediate, "CPX", 2), Instruction::new(0xE1, AddressingMode::IndirectX, "SBC", 6), Instruction::new(0xE2, AddressingMode::Immediate, "SKB", 2), Instruction::new(0xE3, AddressingMode::IndirectX, "ISB", 8), Instruction::new(0xE4, AddressingMode::ZeroPage, "CPX", 3), Instruction::new(0xE5, AddressingMode::ZeroPage, "SBC", 3), Instruction::new(0xE6, AddressingMode::ZeroPage, "INC", 5), Instruction::new(0xE7, AddressingMode::ZeroPage, "ISB", 5), Instruction::new(0xE8, AddressingMode::NoneAddressing, "INX", 2), Instruction::new(0xE9, AddressingMode::Immediate, "SBC", 2), Instruction::new(0xEA, AddressingMode::NoneAddressing, "NOP", 2), Instruction::new(0xEB, AddressingMode::Immediate, "SBC", 2), Instruction::new(0xEC, AddressingMode::Absolute, "CPX", 4), Instruction::new(0xED, AddressingMode::Absolute, "SBC", 4), Instruction::new(0xEE, AddressingMode::Absolute, "INC", 6), Instruction::new(0xEF, AddressingMode::Absolute, "ISB", 6),
    Instruction::new(0xF0, AddressingMode::NoneAddressing, "BEQ", 2), Instruction::new(0xF1, AddressingMode::IndirectY, "SBC", 5), Instruction::new(0xF2, AddressingMode::NoneAddressing, "XXX", 2), Instruction::new(0xF3, AddressingMode::IndirectY, "ISB", 8), Instruction::new(0xF4, AddressingMode::ZeroPageX, "NOP", 4), Instruction::new(0xF5, AddressingMode::ZeroPageX, "SBC", 4), Instruction::new(0xF6, AddressingMode::ZeroPageX, "INC", 6), Instruction::new(0xF7, AddressingMode::ZeroPageX, "ISB", 6), Instruction::new(0xF8, AddressingMode::NoneAddressing, "SED", 2), Instruction::new(0xF9, AddressingMode::AbsoluteY, "SBC", 4), Instruction::new(0xFA, AddressingMode::NoneAddressing, "NOP", 2), Instruction::new(0xFB, AddressingMode::AbsoluteY, "ISB", 7), Instruction::new(0xFC, AddressingMode::AbsoluteX, "IGN", 4), Instruction::new(0xFD, AddressingMode::AbsoluteX, "SBC", 4), Instruction::new(0xFE, AddressingMode::AbsoluteX, "INC", 7), Instruction::new(0xFF, AddressingMode::AbsoluteX, "ISB", 7),
  ];
}
...
impl CPU {
  ...
  fn jmp(&mut self, mode: &AddressingMode) {
    self.registers.pc = self.get_operand_address(mode);
  }
